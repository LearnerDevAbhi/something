 	...
 	common_model.getData(data2,function(response1){
	    if(response1.success==1){
	        ...
	        var data ={
	            ...
	            condition:"round='"+currentRound+"' and roundStatus='Pending' and isEnter='Yes' and  isDelete='No' and  tournamentId='"+match.tournamentId+"'",
	         };
	            ...
	            if(response2.success!=1){
	                ...
	                common_model.sqlQuery(query,function(res){
	                    ...
	                    if(playerLimitInRoom >= inGameEnterTotalCount){
	                        ...
	                        //sql2 +="update tournament_registrations set winningPrice='"+winningPrice+"' where roundStatus='Win'";

	                        common_model.sqlQuery(sql2,function(res4){
	                             var procedure="CALL updateWinnerPrice('"+match.tournamentId+"', '"+winningPrice+"')";
	                             common_model.sqlQuery(procedure,function(res5){
	                                    // console.log(res5)

	                             });
	                        });
	                        // var data ={
	                        //     success:1,message:"End Match You win tournament"
	                        // };
	                        // io.in(match.tableId).emit("tournamenMsg",data);
