...
function validate()
{
    ...
    if(isPrivate=='Yes'){
      if(minimum.trim() == '')
      {
        $("#errminimum").fadeIn().html("Please enter mimimum.");
        setTimeout(function(){$("#errminimum").html("&nbsp;");},3000);
        $("#minimum").focus();
        return false; 
      }
      if(maximum.trim() == '')
      {
        $("#errmaximum").fadeIn().html("Please enter maximum");
        setTimeout(function(){$("#errmaximum").html("&nbsp;");},3000);
        $("#maximum").focus();
        return false; 
      }
      if(minimum > maximum){
        $("#errminimum").fadeIn().html("Minimum is greter than maximum");
        setTimeout(function(){$("#errminimum").html("&nbsp;");},3000);
        $("#minimum").focus();
        return false;  
      }
