               ...
               <div class="box-body">
                  ...
                  <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                        ...
                        <a  download class="btn btn-info"  href="" style="margin: 5px;">Download</a>
                        <?php }  ?>
                     </div>
                     <div class="col-md-6"> 
                  ...
                  <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                        <label for="title">Referal Field 1 <span class="text-danger"> * </span> 200<span id="errReferalFiels1" class="text-danger"><?= strip_tags(form_error('website'));?></span></label>
                        <input type="text" class="form-control" id="referalField1" name="referalField1" value="<?php if(!empty($getdata)) { echo $getdata->referalField1;}?>"/>
                     </div>
                     <div class="form-group col-md-6">
                        <label for="title">Referal Field 2 <span class="text-danger"> * </span> 400<span id="errReferalFiels2" class="text-danger"><?= strip_tags(form_error('topPlayerLimit'));?></span></label>
                        <input type="text" class="form-control" id="referalField2"  name="referalField2" value="<?php if(!empty($getdata)) { echo $getdata->referalField2;}?>" onkeypress="only_number(event)"/>
                     </div>
                  </div>
                  <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                        <label for="title">Referal Field 3 <span class="text-danger"> * </span> 500<span id="errReferalFiels3" class="text-danger"><?= strip_tags(form_error('website'));?></span></label>
                        <input type="text" class="form-control" id="referalField3" name="referalField3" value="<?php if(!empty($getdata)) { echo $getdata->referalField3;}?>"/>
                     </div>
                  </div>
                  <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                        <label for="title">Minimum Deposit<span class="text-danger"> * </span><span id="errminDeposit" class="text-danger"></span></label>
                        <input type="text" class="form-control" id="minDeposit"  name="minDeposit" value="<?php if(!empty($getdata)) { echo $getdata->minDeposit;}?>" onkeypress="only_number(event)"/>
                     </div>
                     <div class="form-group col-md-6">
                        <label for="baseUrl">Minimum Withdraw <span class="text-danger"> * </span><span id="errminWithdraw" class="text-danger"><?= strip_tags(form_error('minWithdraw'));?></span></label>
                        <input type="text" class="form-control" id="minWithdraw"  name="minWithdraw" value="<?php if(!empty($getdata->minWithdraw)){
                           echo $getdata->minWithdraw;
                           }?>" autocomplete="off" onkeypress="only_number(event)">
                     </div>
                  </div>
                  <!-- <div class="form-group col-md-12">
                     <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                        <label for="title">Signup Bonus<span class="text-danger"> * </span><span id="errsignUpBonus" class="text-danger"><?= strip_tags(form_error('signUpBonus'));?></span></label>
                        <input type="text" class="form-control" id="signUpBonus"  name="signUpBonus" value="<?php if(!empty($getdata->signUpBonus)) { echo $getdata->signUpBonus;}?>" onkeypress="only_number(event)"/>
                     </div>
                  </div> -->
                  <div class="form-group col-md-12">
                     <!-- <div class="form-group col-md-6">
                        <label for="title">Cash Bonus<span class="text-danger"> * </span><span id="errcashBonus" class="text-danger"><?= strip_tags(form_error('cashBonus'));?></span></label>
                        <input type="text" class="form-control" id="cashBonus"  name="cashBonus" value="<?php if(!empty($getdata->cashBonus)) { echo $getdata->cashBonus;}?>" onkeypress="only_number(event)"/>
                     </div> -->
                     <div class="form-group col-md-6">
                        <label for="title">Spin Wheel Time<span class="text-danger"> * </span><span id="errspinWheelTimer" class="text-danger"><?= strip_tags(form_error('spinWheelTimer'));?></span></label>
                        <input type="text" class="form-control" id="spinWheelTimer"  name="spinWheelTimer" value="<?php if(!empty($getdata->spinWheelTimer)) { echo $getdata->spinWheelTimer;}?>" onkeypress="only_number(event)"/>
                     </div>
                  </div>
