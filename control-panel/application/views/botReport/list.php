      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box bShow">
                ...
                <div class="col-md-8">
                  <div class="col-md-3 pull-right paddRight">
                    <select class="form-control filter_search_data2" name="isWinLoss" id="isWinLoss">
                      ...
                      <option value="Win" <?php if($isWinLoss=='bot-win'){ echo "selected";} ?>>Win</option>
                      <option value="Loss" <?php if($isWinLoss=='bot-loss'){ echo "selected";} ?>>Loss</option>
                    </select>
                  </div>
                  <div class="col-md-3 pull-right paddRight">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped" id="botreport_datatable" style="width: 100%;">
                <thead>
                <tr>
                  <th>Sr. No.</th>
                  <th>User Name</th>
...
//  var url = '<?= site_url(USERREPORTLIST.'/'.$isWinLoss); ?>';
  var url = '<?= site_url('BotReport/ajax_manage_page/'.$isWinLoss); ?>';
  var actioncolumn=12;
  var pageLength='';
...
<script type="text/javascript">
    ...
    var table = $('#botreport_datatable').DataTable({
        "oLanguage": { 
