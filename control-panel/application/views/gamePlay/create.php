              ...
              <div class="box-body">
               ...
               <!--  <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Minimum <span class="text-danger"> * </span><span id="errminimum" class="text-danger"><?= strip_tags(form_error('minimum'));?></span></label>
                      <input type="text" class="form-control" onkeypress="only_number(event)" name="minimum" id="minimum" placeholder="Enter Minimum Entry Fee" value="<?= $minimum;?>" autocomplete="off" maxlength="4">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Maximum <span class="text-danger"> * </span><span id="errmaximum" class="text-danger"><?= strip_tags(form_error('maximum'));?></span></label>
                      <input type="text" class="form-control" onkeypress="only_number(event)" name="maximum" id="maximum" placeholder="Enter Maximum Entry Fee" value="<?= $maximum;?>" autocomplete="off" maxlength="4">
                    </div>
                  </div>
                </div>
                <?php }?>
                ...
                <input type="hidden" name="isBotConnect" value="No">
               <!-- <?php if($isPrivate=="No"){?>
                <div class="col-md-6">
