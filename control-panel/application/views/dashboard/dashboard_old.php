                ...
                <div class="card">
	                <div class="card-body p-0">
	                    <ul class="users-list clearfix">
						  <?php foreach($getSelectedUser as $rows) { ?>
	                      <li>
                          ...
                          <?php } else { ?>
	                        ...
	                        <span class="users-list-date"><?php if(!empty($rows->last_login) && $rows->last_login !="0000-00-00 00:00:00") { echo " ".date('h:i:s A', strtotime($rows->last_login)); } else { echo "";} ?></span>
	                      </li>
						  <?php } ?>
	                    <!-- /.users-list -->
                  	</div>
...
<script type="text/javascript">
    ...
    xAxis: {
        //categories: ['Feb 2019', 'Mar 2019', 'Apr 2019', 'May 2019', 'Jun 2019', 'Jul 2019', 'Aug 2019'],
        categories: [<?php foreach($getMonthlyAdminAmt as $month){ ?>"<?= $month->MonthName; ?>",<?php } ?>],
    ...
    series: [<?php foreach($getMonthlyAdminAmt as $month){ ?>{
