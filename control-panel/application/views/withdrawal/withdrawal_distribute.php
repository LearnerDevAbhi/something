            ...
            <!-- /.box-header -->
               <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    $action3 =  site_url('Paytm/saveAllDistributerRedeemBypaytm'); 
                 ...
                 <!--  <?php if($getData->status == 'Process'){  ?>
                  ...
                  <?php if($getData->paymentType == 'paytm'){  ?>
                      <form method="post" action="<?= $action3; ?>">
                  <?php } else if($getData->paymentType=='bank'){ ?>
                     <form method="post" action="<?= $action1; ?>" id="showBtn">
                  <?php } ?>
                    ...
                    <div class="col-xs-6" style="padding-left:0" id="myDiv">
                      <table class="table table-bordered table-responsive" border="1">
                         ...
                         <!--  <tr>
                          ...
                          <tr>
                            <td width="180px"><strong>Payment Type</strong></td>
                            <td><?php if(!empty($getData->paymentType)) { echo '<span class="label label-warning">'.$getData->paymentType.'</span>'; } else { echo "NA"; } ?></td>
                          </tr>
                      </table>
                    </div>
                  </div> 
                      ...
                      <div style="padding-left: 10px;" id="refRadio">
                        ...
                        <input type="radio" name="aprbtn" value="patym" class="aprbtn" onclick="btnShow('patym')">Patym
                      </div>
                      <br>
                      <?php } ?>
