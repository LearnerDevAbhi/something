            ...
            <div class="box-header with-border">
              <div class="col-md-4 box-title paddLeft"><?= $heading; ?></div>
               ...
               <div class="col-md-4 text-right paddRight">
                ...
                <input type="hidden" class="filter_search_data1" value="<?= $userId;?>">
                <a href="javascript:history.back(-1)"><button class="btn btn-danger btn-sm">Back</button></a>
              </div> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script type="text/javascript">
  var url = '<?= site_url(TOURNAMENTUSERHISTORYLIST); ?>';
    var actioncolumn=8;
    var  pageLength='';
</script>
<script type="text/javascript">
