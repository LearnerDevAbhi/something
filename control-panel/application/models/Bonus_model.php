...
class Bonus_model extends CI_Model
{
    ...
    var $column_order = array(null,'bs.referalBonus','bs.signupBonus','bs.cashBonus',null,null); //set column field database for datatable orderable
    var $column_search = array('bs.referalBonus','bs.signupBonus','bs.cashBonus'); //set column field database for datatable searchable 
    var $order = array('bs.id' => 'DESC'); 
