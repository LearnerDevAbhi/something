...
class TournamentsUsers_model extends CI_Model
{
	var $column_order = array(null,'tr.userName','tr.entryFee','tr.isEnter','tr.isWin','tr.round','tr.isDelete','tr.created',null); //set column field database for datatable orderable
    var $column_search = array('t.userName','tr.entryFee','tr.isEnter','tr.isWin','tr.round','tr.isDelete','tr.created'); //set column field database for datatable searchable 
    var $order = array('tr.tournamentRegtrationId' => 'DESC'); 
