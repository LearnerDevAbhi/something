...
class Paytm extends CI_Controller 
{
	...
	{
		/*print_r($order_id);echo "<pre>";
		print_r($amt);echo "<pre>";
		print_r($beneficiaryAccount);echo "<pre>";
		print_r($beneficiaryIFSC);echo "<pre>";
		print_r($userAccId);echo "<pre>";
		print_r($withAmt);echo "<pre>";
		exit;*/
		header("Pragma: no-cache");
 		header("Cache-Control: no-cache");
  		header("Expires: 0");
