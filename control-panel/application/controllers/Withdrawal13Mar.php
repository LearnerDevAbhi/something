				                                                ...
				                                                <tbody><tr>
				                                                    <td>
				                                                        ...
				                                                        <table cellspacing="0" cellpadding="10" width="100%">
				                                                            <tbody><tr>
				                                                                <td>
				                                                                    Your withdrawal request of Rs '.$withdrawAmount.' has been Rejected by Admin due to '.$rejectReason.'. please contact us at  <a href="mailto:support@ludofantasy.com" target="_blank">support@ludofantasy.com</a>
				                                                                    <p><b>Thank you,</b></p>
	...
	public function paytmAcceptWithdraw(){
		...
		if(!empty($ids)){
			foreach ($ids as $id) {
				...
				$userMobileNo= $userData[0]->mobile;
