...
class Settings extends CI_controller
{
	...
	public function update_action(){
		...
		// else{
			...
			$data = array(
				...
				'signUpBonus'=>$this->input->post('signUpBonus',TRUE),
				'cashBonus'=>$this->input->post('cashBonus',TRUE),
				'spinWheelTimer'=>$this->input->post('spinWheelTimer',TRUE),
				'referalField1'=>$this->input->post('referalField1',TRUE),
				'referalField2'=>$this->input->post('referalField2',TRUE),
				'referalField3'=>$this->input->post('referalField3',TRUE),
				'minDeposit'=>$this->input->post('minDeposit',TRUE),
				'minWithdraw'=>$this->input->post('minWithdraw',TRUE),
				'videoUrl'=>$videoFile,
				'logo'=>$photo,
			);
	...
	// 	array('required'=>"Please Enter %s."));
	// 	$this->form_validation->set_rules('cashBonus','Cash Bonus','required',
	// 	array('required'=>"Please Enter %s."));
	// 	$this->form_validation->set_rules('spinWheelTimer','Spin Wheel Timer','required',
	// 	array('required'=>"Please Enter %s."));
